...
const Error404 = () => {
  ...
  <img width='400px' height='auto' className='mt-3' style={{ borderRadius: '50%' }} src='/assets/img/404-error.jpg' alt='under construction' />
      <Link to='/'><MyButton text='Go to Hompage' /> </Link>
    </Container>
  )
}
